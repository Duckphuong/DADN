            ...
            <div className="space-y-10">
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between">
                        ...
                        <span
                            className={`${data.hardness?.category === 'Hard Water' ? 'text-blue-600' : 'text-cyan-600'}`}
                        >
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative h-8 bg-gray-100 rounded-full overflow-hidden">
                        ...
                        <div
                            ...
                            style={{
                                width: getWidthPercent(data.alkalinity?.level, [
                                    'Low',
                                    'Moderate',
                                    'High',
                                ]),
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-xs text-gray-700 z-10">
                                {data.alkalinity?.value_mgl} mg/L
                            </span>
                        </div>
                    </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative h-8 bg-gray-100 rounded-full overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-xs text-gray-700 z-10">
                                {data.temperature?.value_celsius?.toFixed(1)} °C
                            </span>
                        </div>
                    </div>
                    <div className="flex justify-between text-xs text-gray-400">
